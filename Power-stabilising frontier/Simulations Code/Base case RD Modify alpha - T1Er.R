...
T1Er.method<-matrix(NA,n.pi0,3)
colnames(T1Er.method)<-1:3
...
# save.image("~/My Documents/Non-inferiority trials/NI Frontiers/Simulation results/Base case RD Modify alpha - T1Er.RData")
...
par(xpd=TRUE)
legend("topright",inset=c(-0.35,0), legend = c("Don't modify", "Modify margin but not alpha", "Modify margin  and alpha"), pch=16, col = c("black","orange", "red", "purple", "brown")) # optional legend
par(xpd=FALSE)
