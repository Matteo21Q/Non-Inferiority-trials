...
# save.image("~/My Documents/Non-inferiority trials/NI Frontiers/Simulation results/Base case RD - Power.RData")

# plot

plot(range.of.pi0, Power.method[,1], type = "b", pch=16, ylim=c(0.4,1), xlab = expression(pi[0]), ylab= "Power", main = "Risk difference")
...
legend("bottomleft", legend = c("Method 1", "Method 2", "Method 3", "Method 4"), pch=16, col = c("black","blue","orange", "green")) # optional legend
