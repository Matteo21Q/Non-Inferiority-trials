...
pdf(file="Alternatives 4.pdf",width=10,height=12)
m <- matrix(c(1,2,3,4,5,5),nrow = 3,ncol = 2,byrow = TRUE)
layout(mat = m,heights = c(0.4, 0.4, 0.2))

load("~/Documents/Non-inferiority trials/NI Frontiers/Simulation results/Alternatives 4 RD - T1Er.RData")
...
load("~/Documents/Non-inferiority trials/NI Frontiers/Simulation results/Alternatives 4 RR - T1Er.RData")
plot(range.of.pi0, T1Er.method[,1], type = "l", lwd=2, ylim=c(0,0.2), 
...
load("~/DOcuments/Non-inferiority trials/NI Frontiers/Simulation results/Alternatives 4 RD - Power.RData")
...
load("~/DOcuments/Non-inferiority trials/NI Frontiers/Simulation results/Alternatives 4 RR - Power.RData")
plot(range.of.pi0, Power.method[,1], type = "l", lwd=2, ylim=c(0,1), 
